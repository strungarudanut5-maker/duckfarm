                      ...
                      <div key={duck.id} style={S.duckCard}>
                        <G style={{background:`linear-gradient(160deg,${r.color}1a,rgba(6,6,20,0.97))`,borderColor:`${r.color}35`,padding:"16px"}} glow={r.glow}>
                          ...
                          <div style={{display:"flex",gap:7,marginTop:10}}>
                            ...
                            {mining&&!mDone&&<button style={{...S.actionBtn,flex:1,background:"rgba(251,191,36,0.15)",border:"1px solid rgba(251,191,36,0.4)",fontSize:10}} onClick={()=>skipMining(duck.id)}>⏩ Skip <CI s={10}/>{(skipCount+1)*10}</button>}
              ...
              <div style={S.col}>
                ...
                {breedSlot&&(
                  <G style={{textAlign:"center",borderColor:"rgba(167,139,250,0.35)"}} glow="#7c3aed">
                    ...
                    <button style={{...S.btn,marginTop:10,width:"100%",background:"rgba(251,191,36,0.12)",border:"1px solid rgba(251,191,36,0.35)",fontSize:11}} onClick={skipBreeding}>⏩ Skip <CI s={11}/>{(skipCount+1)*10}</button>
                  </G>
                )}
                {breedRes&&!breedSlot&&(
