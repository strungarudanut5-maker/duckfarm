...
export const G=({children,style={},glow="",onClick})=>(
  <div onClick={onClick} style={{background:"rgba(255,255,255,0.04)",backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:20,padding:"13px 14px",boxShadow:glow?`0 0 24px ${glow}33, 0 4px 24px rgba(0,0,0,0.4)`:"0 4px 24px rgba(0,0,0,0.3)",...style}}>{children}</div>
);
